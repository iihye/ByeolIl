...
public class JwtTokenProvider {
	...
	public TokenInfo generateToken(Authentication authentication) {
		...
		// Access Token 생성
		Date accessTokenRefreshIn = new Date(now + 3000000);
		...
		// Refresh Token 생성
		String refreshToken = Jwts.builder().setExpiration(accessTokenExpiresIn).signWith(key, SignatureAlgorithm.HS256)
				.compact();
