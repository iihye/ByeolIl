  ...
  return (
    <div>
      <Card className="Find w-96 h-max card-contain-style bg-modal-bg text-white-sub px-6 py-6 rounded-component">
        ...
        <CardContent>
          <div className="mb-4">
            <label className="regist-label">가입시 입력한 이메일을 입력해주세요</label>
            <input className="find-input" ref={email} />
          </div>

          <div className="mb-4">
            <label className="regist-label">가입시 입력한 이름을 입력해주세요</label>
            <input className="find-input" ref={membername} />
          </div>

          <div className="mb-4">
            {toFind === "PW" ? (
              <label className="regist-label">사용 중인 아이디를 입력해주세요</label>
            ) : null}
            {toFind === "PW" ? (
              <div>
